...
export interface DependentExpenseFieldValuesUploadResponse { 
    /**
    ...
    state?: DependentExpenseFieldValuesUploadResponse.StateEnum;
}
export namespace DependentExpenseFieldValuesUploadResponse {
