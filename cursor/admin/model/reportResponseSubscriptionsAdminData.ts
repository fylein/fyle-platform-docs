...
export interface ReportResponseSubscriptionsAdminData { 
    /**
     ...
     */
    tax: number | null;
    state: ReportResponseSubscriptionsAdminData.StateEnum;
    /**
    ...
    updated_by_user?: UserPartial;
}
export namespace ReportResponseSubscriptionsAdminData {
