...
export interface DependentExpenseFieldValuesDownloadResponse { 
    /**
     ...
     */
    file_id?: string | null;
    state?: DependentExpenseFieldValuesDownloadResponse.StateEnum;
}
export namespace DependentExpenseFieldValuesDownloadResponse {
